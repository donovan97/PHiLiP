...
/// Class for Coarse state POD basis, derived from POD
template <int dim>
class CoarseStatePOD : public StatePOD<dim>, public CoarseBasis<dim>
{
private:
...
/// Class for Fine not in Coarse state POD basis, derived from POD
template <int dim>
class FineNotInCoarseStatePOD : public StatePOD<dim>, public FineNotInCoarseBasis<dim>
{
private:
...
/// Class for Fine state POD basis, derived from POD
template <int dim>
class FineStatePOD : public StatePOD<dim>, public FineBasis<dim>
{
private:
