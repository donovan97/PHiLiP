#ifndef __POD_ERROR_ADAPTATION__
#define __POD_ERROR_ADAPTATION__
...
public:
    /// Constructor
    PODErrorAdaptation(std::shared_ptr<DGBase<dim,double>> &dg_input, Functional<dim,nstate,double> &functional_input);
